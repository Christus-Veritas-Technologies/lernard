    ...
    return (
        <div className="space-y-6">
            ...
            <section className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                <DashboardStatCard
                    icon={<Rocket01Icon size={14} />}
                    label="Monthly activity"
                    value={dashboardLoading ? "..." : monthlyUsageLabel}
                />
                <DashboardStatCard
                    icon={<SchoolReportCardIcon size={14} />}
                    label="Score trend"
                ...
                />
                <DashboardStatCard
                    icon={<SignalMedium02Icon size={14} />}
                    label="Growth areas"
...
function DashboardStatCard({ icon, label, value }: { icon: ReactNode; label: string; value: string }) {
    return (
        <Card className="border border-border bg-background-subtle/50">
