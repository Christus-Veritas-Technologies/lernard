...
import type { LessonContent, LessonSection, PagePayload, PostLessonContent } from "@lernard/shared-types";
...
export function LessonPageClient({ payload }: { payload: PagePayload<LessonContent> }) {
