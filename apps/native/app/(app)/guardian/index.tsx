        ...
        return (
            <SafeAreaView className="flex-1 bg-background" edges={['top']}>
                <View className="flex-1 px-4 pb-24 pt-6">
                    <StateNotice
                        badge="Loading"
                        description="Pulling linked children, pending invites, and live guardian permissions."
                        title="Building your Household overview"
                    />
                </View>
            </SafeAreaView>
        );
            ...
            <ScrollView className="flex-1" contentContainerClassName="px-4 pb-24 pt-6 gap-6">
                <View className="rounded-[32px] bg-[rgb(248,251,255)] p-6 shadow-sm">
                    ...
                    <Text className="mt-3 text-base leading-7 text-slate-600">
                        Keep every child in view, spot who needs a nudge, and handle companion controls without digging through settings.
                    </Text>
                ...
                <View className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <View className="mt-5 gap-4">
                        {content.pendingInvites.length ? content.pendingInvites.map((invite) => (
                            ...
                            <Text className="text-base leading-7 text-slate-600">
                                You do not have any pending invites right now.
                            </Text>
                        )}
                    </View>
                </View>
