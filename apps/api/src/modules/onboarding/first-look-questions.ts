...
const QUESTION_BANK: Record<string, SubjectQuestions> = {
  ...
  english: {
    beginner: {
      question: 'Which word is a noun in this sentence: "The cat sat on the mat"?',
    ...
    intermediate: {
      ...
      correctAnswer: 2,
      explanation: 'Giving the wind a human quality (whispering) is personification.',
    },
    advanced: {
      question: 'In which narrative perspective does the narrator know the thoughts of every character?',
      options: ['First person', 'Second person', 'Third-person limited', 'Third-person omniscient'],
      correctAnswer: 3,
      explanation: 'Third-person omniscient narrators have access to all characters\' inner thoughts.',
    },
  },
  science: {
    beginner: {
    ...
    advanced: {
      ...
      correctAnswer: 2,
      explanation: 'Le Chatelier\'s Principle: an equilibrium system shifts direction to counteract a disturbance.',
    },
  },
  history: {
    beginner: {
    ...
    intermediate: {
      ...
      correctAnswer: 0,
      explanation: 'The assassination of Archduke Franz Ferdinand in 1914 was the immediate trigger for WWI.',
    },
    advanced: {
      ...
      correctAnswer: 1,
      explanation: 'The Marshall Plan (1948) provided US aid to help Western European economies recover after WWII.',
    },
  },
  geography: {
    beginner: {
      ...
      correctAnswer: 2,
      explanation: 'Asia is the largest continent, covering about 44 million km².',
    },
    intermediate: {
      question: 'What drives the movement of tectonic plates?',
      options: ['Ocean currents', 'Convection currents in the mantle', 'Solar wind', 'Rotation of the Earth'],
      correctAnswer: 1,
      explanation: 'Heat-driven convection currents in the Earth\'s mantle move tectonic plates.',
    },
    advanced: {
      ...
      correctAnswer: 0,
      explanation: 'The Coriolis effect deflects moving air and water due to Earth\'s rotation.',
    },
  },
  'computer science': {
    beginner: {
    ...
    advanced: {
      ...
      correctAnswer: 1,
      explanation: 'A stack follows LIFO: the last item pushed is the first popped.',
    },
  },
  physics: {
    beginner: {
    ...
    intermediate: {
      question: 'An object accelerates at 5 m/s² with a mass of 10 kg. What force acts on it?',
      options: ['2 N', '15 N', '50 N', '500 N'],
      correctAnswer: 2,
      explanation: 'F = ma = 10 × 5 = 50 N.',
    },
    advanced: {
      question: 'According to special relativity, what happens to an object\'s mass as it approaches the speed of light?',
      options: ['It decreases', 'It stays the same', 'It increases', 'It becomes undefined'],
      correctAnswer: 2,
      explanation: 'Relativistic mass increases as velocity approaches c, per Lorentz factor γ.',
    },
  },
  chemistry: {
    beginner: {
    ...
    intermediate: {
      question: 'In the periodic table, what do elements in the same group share?',
      options: ['Same number of protons', 'Same atomic mass', 'Same number of valence electrons', 'Same electron shells'],
      correctAnswer: 2,
      explanation: 'Elements in the same group have the same number of valence electrons, giving similar chemical properties.',
    },
    advanced: {
      question: 'What type of reaction occurs when an acid and a base react to form water and a salt?',
  ...
  biology: {
    ...
    intermediate: {
      ...
      correctAnswer: 1,
      explanation: 'DNA encodes the instructions for building proteins and passing on hereditary information.',
    },
    advanced: {
      question: 'Which process describes how mRNA is produced from a DNA template?',
      options: ['Translation', 'Replication', 'Transcription', 'Transduction'],
      correctAnswer: 2,
      explanation: 'Transcription: DNA is used as a template to produce mRNA in the nucleus.',
    },
  },
  art: {
    beginner: {
      ...
      correctAnswer: 3,
      explanation: 'The primary colours (in traditional mixing) are red, yellow, and blue.',
    },
    intermediate: {
      question: 'What art movement was Salvador Dalí associated with?',
      options: ['Impressionism', 'Cubism', 'Surrealism', 'Baroque'],
      correctAnswer: 2,
      explanation: 'Dalí was a leading figure of Surrealism, known for dreamlike imagery.',
    },
    advanced: {
      question: 'What technique involves painting on freshly laid wet plaster?',
      options: ['Tempera', 'Fresco', 'Encaustic', 'Gouache'],
      correctAnswer: 1,
      explanation: 'Fresco (from Italian "fresh") involves applying pigments to wet plaster so they bond as it dries.',
    },
  },
  music: {
    beginner: {
    ...
    advanced: {
      question: 'In sonata form, what is the section that develops and explores melodic themes called?',
      options: ['Exposition', 'Development', 'Recapitulation', 'Coda'],
      correctAnswer: 1,
      explanation: 'The development section transforms and explores the themes introduced in the exposition.',
    },
  },
};
